<div id="navg" class="d-flex flex-column flex-md-row align-items-center p-3 px-md-4 mb-3 bg-primary border-bottom shadow-sm">
    ...
    <?php else : ?>
        ...
        <a class="btn btn-outline-primary bg-light border-warning font-weight-bold text-warning" href="components/signup.php">Sign up</a>
    <?php endif; ?>
    <style>
        #main__logo {
            padding: 2px;
